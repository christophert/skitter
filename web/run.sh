...
extract_json_data full_cert.json certificate /etc/ssl/skitterweb.pem
extract_json_data full_cert.json private_key /etc/ssl/skitterweb.key

cat ca.crt >> /etc/ssl/skitterweb.pem

openssl dhparam /etc/ssl/dhparam.pem 2048
